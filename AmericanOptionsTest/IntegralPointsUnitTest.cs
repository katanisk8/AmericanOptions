...
namespace AmericanOptionsTest
{
   public class IntegralPointsUnitTest
   {
      ...
      public void CalculateIntegralPointD1Test()
      {
         ...
         var d1 = integralPoints.CalculateIntegralPointD1(S, B, r, sigma, t);

         Assert.Equal(0.35000000000000003, d1.Result.Value);
      }
      ...
      public void CalculateIntegralPointD2Test()
      {
         ...
         var d1 = integralPoints.CalculateIntegralPointD1(S, B, r, sigma, t);
         var d2 = integralPoints.CalculateIntegralPointD2(d1, sigma, t);

         Assert.Equal(0.15000000000000002, d2.Result.Value);
      }
   }
}
